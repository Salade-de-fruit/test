public class main {
    ...
    public static void main(String[] args )
    {
        ...
        System.out.println("L’affaire des fiches, parfois appelée l'affaire des casserolesN 1, est un scandale politique qui éclate en 1904 en France, sous la Troisième République. Il concerne une opération de fichage politique et religieux mise en place dans l'Armée française à l'initiative du général Louis André, ministre de la Guerre, dans un contexte de liquidation de l'affaire Dreyfus et d'accusations d'anti-républicanisme portées par la gauche à l'encontre du corps des officiers.\n" +
                "\n" +
